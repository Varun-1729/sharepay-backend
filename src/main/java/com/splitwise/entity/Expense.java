...
public class Expense {
    ...
    // One-to-many relationship with expense splits
    ...
    public Expense(String description, BigDecimal amount, User paidBy, Group group, String notes) {
        this(description, amount, paidBy, group);
        this.notes = notes;
    }
